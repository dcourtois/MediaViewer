...
//!
//! This component allows to mimic a normal desktop window using a frameless one. This allows to save
//! a bit of screen estate by displaying the application menu and the title bar in the same line.
//!
//! Usage:
//! ```
//! FramelessWindow {
